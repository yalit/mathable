...
export interface CellsQueryRepositoryInterface
  ...
  findCellInCrossFromCell: (cell: Cell) => Promise<Cell[][]>;
...
export class CellsQueryRepository implements CellsQueryRepositoryInterface {
  ...
  constructor(
    ...
    tiles: TilesQueryRepositoryInterface,
    games: GamesQueryRepositoryInterface,
  ) {
    this.db = db;
  ...
  static create(
    ...
    CellsQueryRepository.instance = new CellsQueryRepository(
      db,
      tileRepositoryInterface,
      gameQueryRepositoryInterface,
    );
    return CellsQueryRepository.instance;
  }
  ...
  async findCellInCrossFromCell(cell: Cell): Promise<Cell[][]> {
