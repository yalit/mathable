...
export const resetTurn = withSessionMutation({
    ...
    handler: async (ctx, {gameId}) => {
        ...
        const player = await PlayersQueryRepository.instance.findCurrentPlayer(game._id)
...
export const endTurn = withSessionMutation({
    ...
    handler: async (ctx, {gameId}) => {
        ...
        const currentPlayer = await PlayersQueryRepository.instance.findCurrentPlayer(game._id)
        ...
        const nextPlayer = await PlayersQueryRepository.instance.findNextPlayer(game._id)
        ...
        const currentPlayerTiles = await TilesQueryRepository.instance.findByPlayer(currentPlayer._id)
        ...
        const currentTiles = await TilesQueryRepository.instance.findByPlayer(currentPlayer._id)
